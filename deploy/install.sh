...
# Install OS Dependencies (Python venv, OpenCV system libs, SQLite)
echo "Installing OS dependencies..."
sudo apt install -y python3-pip python3-venv python3-opencv libopencv-dev sqlite3
...
# Install Project Requirements (Using RPi version - opencv-headless)
